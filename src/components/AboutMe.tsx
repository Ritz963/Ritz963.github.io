  ...
  return (
    <div className="relative z-10">
      <SectionHeader
        ...
        description={
          <div>
            I&apos;m a <span className="text-about_me_green">software engineer</span> and <span className="text-about_me_green">CS + Math student</span> at UMD
          </div>
        }
      />
      <Stars id="about-me" />
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Ritvik Thakur</h3>
            <p className="text-base leading-7 text-about_me_green">Software Engineer · CS + Math @ UMD</p>
              ...
              >
                ...
                <div className="border-y py-2 border-gray-500/30 mb-6">
                  <div className="flex flex-wrap gap-x-6">
                    ...
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">Hindi</p> - <p className="text-gray-500">Intermediate</p>
                    </div>
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">Mandarin</p> - <p className="text-gray-500">Novice</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
              ...
              <GlowCard className="hover:shadow-about_me_green/90" glowClassName="from-[#6bc072] to-[#6bc072]">
                <div className="flex flex-col gap-8 @lg:flex-row justify-between">
                  <div className="flex-none mx-auto self-center">
                    <Image className="rounded-2xl object-fill" src="/umd-logo.png" alt="University of Maryland campus" width={144} height={144} />
                  </div>
                  <div className="max-w-xl flex-auto">
                    <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">B.S. in Computer Science and Mathematics</h3>
                    <p className="text-base leading-7 text-about_me_green">University of Maryland, College Park</p>
                  </div>
                </div>
              </GlowCard>
            </FadeIn>
