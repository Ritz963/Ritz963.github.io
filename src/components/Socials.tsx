...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/ritvik-thakur', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/Ritz963', icon: GitHubIcon },
];
    ...
    <FadeInStagger role="list" className={clsx('flex gap-x-4 text-white mt-5', className)}>
      {socialMediaProfiles.map((socialMediaProfile) => (
        <FadeIn key={socialMediaProfile.title}>
          <Link href={socialMediaProfile.href} target="_blank" rel="noopener noreferrer" aria-label={socialMediaProfile.title} className="transition hover:text-white/80 duration-200">
